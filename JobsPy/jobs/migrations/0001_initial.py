    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.CharField(choices=[('Full time', 'Full time'), ('Part time', 'Part time'), ('Remote', 'Remote'), ('Internship', 'Internship')], max_length=10)),
                ...
                ('needed_skills', models.ManyToManyField(related_name='needed_skills', to='main.skills')),
